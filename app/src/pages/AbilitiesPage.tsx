    ...
    <div>
      <PageHeader title="Abilities" mode={mode}>
        {mode === "pve" ? (
          ...
          <>
            The AOS loadout: Foxflare Fling (Magnus) learned, rabams Spirit Parade / Petal Snare /
            Soul Charm (confirmed from the rank-1 observation), Petalblast unlocked. PvP always
